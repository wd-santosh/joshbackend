    ...
    <section class="purchas-main">
        <div class="container bg-border wow pulse" data-wow-duration="2.5s">
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12 col-12 col-lg-4"><a href="#" class="btn purchase-styl float-lg-right">Purchase
                    now</a></div>
            </div>
        </div>
    </section>
...
<div class="container">
    <div class="row">
        ...
        <div class="text-center col-12 wow flash my-3" data-wow-duration="3s">
            <h3><span class="heading_border bg-success">Accordions</span></h3>
...
<div class="container">
    <div class="row text-center">
        <div class="col-12 my-3">
            <h3><span class="heading_border bg-danger">Our Team</span></h3></div>
    </div>
    <div class="row text-center">
    ...
    <div class="row features">
        ...
        <div class=" col-12 text-center my-3">
            <h3><span class="heading_border bg-warning">Features</span></h3>
        </div>
        <!--</div>-->
    ...
    <div class=" col-12 text-center my-3 marbtm10">
        <h3><span class="heading_border bg-danger">Our Skills</span></h3>
    </div>
</div>
    <!--</div>-->
    <div class="sliders">
