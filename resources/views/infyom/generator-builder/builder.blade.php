            ...
            <div class="card-body">
                ...
                <form id="form" action="#" class="basic_steps">
                    ...
                    <div class="mt-2 mb-3">
                        ...
                        <div class="col-md-12 mb-3">
                            <ul class="instructions">
                                <li><strong>If you need a field name <code>First Name</code>, type field name as <code>first_name</code></strong></li>
                ...
                <div class="form-group btn_generate">
                    <button type="button" class="btn btn-light btn-flat" id="btnReset" data-toggle="modal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-flat btn-light" data-dismiss="modal">No
                        </button>
                    </div>
                </div>
            </div>
