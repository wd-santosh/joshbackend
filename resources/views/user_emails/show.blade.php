                            ...
                            <th colspan="4">
                                <div class="row no-padding">
                                    <div class="col-md-7 col-lg-9 col-xs-12">
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-light btn-toolbar" data-toggle="tooltip" data-placement="top" title="Delete Message" >
                                                <i class="fa fa-trash-o text-danger"></i>
                                            </a>
                                            <button type="button" class="btn btn-light btn-toolbar" data-toggle="tooltip" data-placement="top" title="Refresh">
