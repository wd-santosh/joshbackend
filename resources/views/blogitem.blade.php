...
@section('content')
    ...
    <div class="container">
        <h2 class="primary marl12 my-3">{{$blog->title}}</h2>
                    ...
                    <div class="the-box no-border blog-detail-content">
                        ...
                        <div class="blog-detail-image">
                            @if(!empty($blog->summernote_image))
                                <img src="{{URL::to('uploads/blog/'.$blog->summernote_image)}}" class="img-fluid summernote_image" alt="Image">
                            @endif
                        </div>
                        <p>
                            <strong>Tags: </strong>
                        ...
                        <ul class="pl-0">
                            <li class="media">
                                <a class="float-left" href="#">
                                    <img src="{{ asset('images/authors/avatar1.jpg') }}" class="rounded-circle img-fluid float-left mr-3" alt="riot">
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <a class="float-left" href="#">
                                    <img src="{{ asset('images/authors/avatar4.jpg') }}" class="rounded-circle img-fluid float-left mr-3" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
                            ...
                            <li class="media">
                                <a class="float-left" href="#">
                                    <img src="{{ asset('images/authors/avatar5.jpg') }}" class="rounded-circle img-fluid float-left mr-3" alt="riot">
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading primary">
