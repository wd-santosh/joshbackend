...
@section('content')
    ...
    <div class="container my-3">
        ...
        <div class="row my-3">
            ...
            <div class="col-md-6 col-sm-12 col-12 col-lg-6 col-xl-3 my-3 wow flipInY" data-wow-duration="3.5s">
                <div class="card card_price">
                    <div class="text-center">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="success text-center my-2">Per Month</h4>
            ...
            <div class="col-md-6 col-sm-12 col-lg-6 col-xl-3 col-12 my-3 wow flipInY" data-wow-duration="3s" data-wow-delay="0.7s">
                <div class="card card_price">
                    <div class="text-center">
                    <div class="card-header card_heading">
            ...
            <div class="col-md-6 col-sm-12 col-lg-6 col-xl-3 col-12 my-3 wow flipInY" data-wow-duration="3s" data-wow-delay="1.2s">
                <div class="card card_price">
                    <div class="text-center">
                        <div class="card-header card_heading">
            ...
            <div class="col-md-6 col-sm-12 col-lg-6 col-12 col-xl-3 my-3 wow flipInY" data-wow-duration="3s" data-wow-delay="1.6s">
                <div class="card card_price">
                    <div class="text-center">
                        <div class="card-header card_heading">
