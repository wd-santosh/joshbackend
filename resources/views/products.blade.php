...
@section('header_styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/frontend/shopping.css') }}">
...
@section('content')
    ...
    <div class="container my-3">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/htc.jpg') }}" class="img-fluid" alt="htc image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/sony.jpg') }}" class="img-fluid" alt="sony image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/karbon.jpg') }}" class="img-fluid" alt="karbon image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/nokia.jpg') }}" class="img-fluid" alt="nokia image"></a>
                    <br/>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/samsung balck.jpg') }}" class="img-fluid" alt="samsung black image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/samsung.jpg') }}" class="img-fluid" alt="samsung image"></a>
                    <br/>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/saree.jpg') }}" class="img-fluid" alt="saree image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/saree2.jpg') }}" class="img-fluid" alt="saree2 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/saree3.jpg') }}" class="img-fluid" alt="saree3 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/saree4.jpg') }}" class="img-fluid" alt="saree4 image"></a>
                    <br/>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/men.jpg') }}" class="img-fluid" alt="men image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/men2.jpg') }}" class="img-fluid" alt="men2 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/men3.jpg') }}" class="img-fluid" alt="men3 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('images/cart/men4.jpg') }}" class="img-fluid" alt="men4 image"></a>
                    <br/>
