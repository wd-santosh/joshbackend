            ...
            <div id="gallery">
                <div id="portfolio_btns">
                    ...
                    <div class="mix category-1" data-my-order="1">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/10.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-1" data-my-order="2">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/8.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-2" data-my-order="3">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/7.jpg') }}" class="img-fluid"> </div>
                    </div>
                    ...
                    <div class="mix category-2" data-my-order="5">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/5.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-2" data-my-order="6">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/4.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-1" data-my-order="7">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/3.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-2" data-my-order="8">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/2.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-2" data-my-order="8">
                        <div class="col-md-3 col-sm-6 col-6">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/1.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-1" data-my-order="8">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/11.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-1" data-my-order="8">
                        <div class="col-md-3 col-sm-6 col-6">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/12.jpg') }}" class="img-fluid"> </div>
                    </div>
                    <div class="mix category-2" data-my-order="8">
                        <div class="col-md-3 col-sm-6 col-6">
                        ...
                        <div class="thumb_zoom"><img src="{{ asset('images/gallery/9.jpg') }}" class="img-fluid"> </div>
                    </div>
                </div>
                    </div>
                </div>
