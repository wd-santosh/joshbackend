            ...
            <div class="card ">
                ...
                <div class="card-body">
					...
					<span class="input-group-prepend">
						<button class="btn btn-light input-group-text" type="button" data-select2-open="single-prepend-text1">
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<div class="input-group select2-bootstrap-prepend dropdowns-select-prepend">--}}
                                        {{--<div class="input-group-btn">--}}
                                            {{--<button class="btn btn-light input-group-text remove_radius_right" type="button"--}}
                    ...
                    <div class="form-group d-table-cell">
                        ...
                        <div class="input-group select2-bootstrap-append dropdowns-select-multiappend ">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-light remove_radius" type="button" data-select2-open="multi-append">
                                    <span class="fa fa-search"></span>
                                </button>
                                <button class="btn btn-light remove_radius" type="button" data-select2-open="multi-prepend">State
                                </button>
