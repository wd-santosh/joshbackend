                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="types" class="btn-group">
                                            <button name="color" type="button" class="btn btn-light" value="btn-light">Default</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 m-b-5">
                                                    ...
                                                    <div id="icon-position" class="btn-group">
                                                        <button class="btn btn-light" value="left" type="button">
                                                            <span class="glyphicon glyphicon-arrow-left"></span>
                                                            &nbsp; &nbsp;Left
                                                        </button>
                                                        <button class="btn btn-light" value="right" type="button">
                                                            Right &nbsp; &nbsp;
