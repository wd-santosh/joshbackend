                                            ...
                                            <div class="form-position">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9 ml-auto">
                                                        ...
                                                        &nbsp;
                                                        <input type="reset"
                                                               class="btn btn-light d-none d-lg-inline-block d-sm-inline-block d-md-inline-block"
                                                               value="Reset">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <form action="#" class="form-horizontal">
                                            ...
                                            <div class="form-actions">
                                                <div class="col-md-offset-3 col-md-9 ml-auto">
                                                    ...
                                                    <button type="button" class="btn btn-danger">Cancel</button>
                                                    &nbsp;
                                                    <input type="reset" class="btn btn-light hidden-xs" value="Reset">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <div class="form-body my-2">
                                                ...
                                                <div class="form-actions">
                                                    <div class="col-md-offset-3 col-md-9 ml-auto">
                                                        ...
                                                        <button type="button" class="btn btn-danger">Cancel</button>
                                                        &nbsp;
                                                        <input type="reset" class="btn btn-light hidden-xs"
                                                               value="Reset">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <form action="#">
                                            <div class="form-position ">
                                                ...
                                                <button type="button" class="btn btn-danger">Cancel</button>
                                                &nbsp;
                                                <input type="reset" class="btn btn-light d-none d-sm-inline-block"
                                                       value="Reset">
                                            </div>
                                                    ...
                                                    <div class="form-group form-actions">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <button type="reset"
                                                                        class="btn btn-effect-ripple btn-light">Reset
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group form-actions">
                                                <div class="row">
                                                    <div class="col-md-9 col-md-offset-3 ml-auto">
                                                        ...
                                                        <button type="reset" class="btn btn-effect-ripple btn-light">
                                                            Reset
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <form action="#" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-group form-actions">
                                                        <div class="col-md-9 col-md-offset-3 ml-auto">
                                                            ...
                                                            <button type="reset"
                                                                    class="btn btn-effect-ripple btn-light">
                                                                Reset
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <form role="form" class="form-horizontal">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <button type="reset"
                                                                    class="btn btn-effect-ripple btn-light btn_margin_top">
                                                                Reset
                                                            </button>
                                                        </div>
                                                    </div>
