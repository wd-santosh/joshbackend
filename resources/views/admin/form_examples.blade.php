                        ...
                        <form role="form">
                            ...
                            <div class="form-group input-group">
                                ...
                                <div class="input-group-append">
                                        <span class="input-group-btn input-group-append">
                                            <button class="btn btn-light input-group-text image_radius" type="button">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    ...
                                    <a href="#" class="btn btn-light fileinput-exists color_a" data-dismiss="fileinput">Remove</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                            <span class="btn btn-light btn-file">
                                                ...
                                                <span class="fileinput-exists">Change</span>
                                                <input type="file" name="..."></span>
                                        <a href="#" class="btn btn-light fileinput-exists color_a ml-2" data-dismiss="fileinput">Remove</a>
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-responsive btn-light">Submit Button</button>
                            <button type="reset" class="btn btn-responsive btn-light" id="reset">Reset Button</button>
                        </form>
                    </div>
                </div>
            </div>
