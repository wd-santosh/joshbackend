                    ...
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12 text-center mb-3">
                                <div class="ui-group-buttons">
                                    <a href="#" class="btn btn-success" role="button">
                                        <span class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#fff" data-hc="white" ></span>
                                        <span>Sign Up</span>
                                    </a>
                                    <div class="or text-white"></div>
                                    <a href="#" class="btn btn-info" role="button">
                                        <span class="livicon" data-name="remove" data-size="18" data-loop="true" data-c="#333" data-hc="black" ></span>
                                        <span>Reset</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-4 text-center">
                                        <a href="#" class="btn btn-warning btn-sm btn-responsive" role="button">
                                            <span class="livicon" data-name="bookmark" data-size="14" data-loop="true"
                                                  data-c="#fff" data-hc="white"></span>
                                            <br/> Bookmarks
                                        </a>
                                    </div>
                                    <div class="col-4 text-center">
                                        <a href="#" class="btn btn-primary btn-sm btn-responsive" role="button">
                                            <span class="livicon" data-name="signal" data-size="14" data-loop="true"
                                                  data-c="#fff" data-hc="white"></span>
                                            <br/> Reports
                                        </a>
                                    </div>
                                    <div class="col-4 text-center">
                                        <a href="#" class="btn btn-primary btn-sm btn-responsive" role="button">
                                            <span class="livicon" data-name="tag" data-size="14" data-loop="true"
                                                  data-c="#fff" data-hc="white"></span>
                                            <br/> Tags
                                        </a>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-4 text-center">
                                        ...
                                        <span class="btn-label float-left">
                                                <i class="livicon" data-name="refresh" data-size="16" data-loop="true"
                                                   data-c="#fff"
                                                   data-hc="white"></i>
                                            </span>
                                    ...
                                    <div class="col-4 text-center">
                                        ...
                                        <span class="btn-label float-left">
                                                <i class="livicon" data-name="remove" data-size="16" data-loop="true"
                                                   data-c="#fff"
                                                   data-hc="white"></i>
                                            </span>
