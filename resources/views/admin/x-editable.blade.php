...
@section('header_styles')
        <!-- page level css -->
        <link href="{{ asset('vendors/x-editable/css/x-select.css') }}" type="text/css" rel="stylesheet" />
        <link href="{{ asset('vendors/x-editable/css/bootstrap-editable.css') }}" type="text/css" rel="stylesheet" />
        <link href="{{ asset('vendors/x-editable/css/x-selectbootstrap.css') }}" type="text/css" rel="stylesheet" />
        <link href="{{ asset('vendors/x-editable/css/typeahead.js-bootstrap.css') }}" type="text/css" rel="stylesheet" />
        <link href="{{ asset('vendors/iCheck/css/all.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('css/pages/inlinedit.css') }}" rel="stylesheet" />
...
<section class="content pr-3 pl-3">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12 my-3">
            <div class="card">
                <div class="card-header buttons bg-info">
                    <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-12 text-right">
                        <form method="get" id="frm" class="form-inline-block" action="#">
                            <label>
...
@section('footer_scripts')
    ...
    <script src="{{asset('js/pages/xeditable-bs4.js')}}"></script>
    ...
    <script src="{{ asset('js/pages/demo-mock.js') }}" ></script>
