                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control required"  title="Select group..." name="groups[]"
                                                        ...
                                                        @foreach($roles as $role)
                                                            <option value="{!! $role->id !!}" {{ (array_key_exists($role->id, $userRoles) ? ' selected="selected"' : '') }} @if($user->id==1&&$role->id>=2) disabled @endif @if($user->id==2 && $role->id!=2) disabled @endif>{{ $role->name }}</option>
                                                        @endforeach
                                                    </select>
