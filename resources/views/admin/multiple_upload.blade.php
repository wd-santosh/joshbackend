                    ...
                    <div class="card border-primary">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div class="float-right">
                                <button class="btn btn-sm btn-light" data-toggle="modal" data-target="#multiplefile">Add New</button>
                                {{--<a href="{{ URL::to('admin/blog/create') }}" class="btn btn-sm btn-light"><span class="fa fa-plus"></span> @lang('button.create')</a>--}}
                            </div>
                        </div>
