            ...
            <div class="card ">
                ...
                <div class="card-body table-responsive-lg table-responsive-md table-responsive-sm">
                    ...
                    <div class="btn-group" style="margin:10px 0;">
                        <button type="button" class="toggle-vis btn btn-light" data-column="0">Name</button>
                        <button type="button" class="toggle-vis btn btn-light" data-column="1">User Name
                        </button>
                        <button type="button" class="toggle-vis btn btn-light" data-column="2">Email</button>
                        <button type="button" class="toggle-vis btn btn-light" data-column="3">Department
                        </button>
                        <button type="button" class="toggle-vis btn btn-light" data-column="4">Contact
                        </button>
                    </div>
