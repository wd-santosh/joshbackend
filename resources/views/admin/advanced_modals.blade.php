                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-raised btn-light md-trigger" data-toggle="modal"
            ...
            <!--<div class="md-content">-->
                ...
                <!--<div class="modal-red">-->
                    ...
                    <!--<ul>-->
                        ...
                        <!--</li>-->
                    <!--</ul>-->
                    <!--<button class="btn btn-modal btn-light md-close">Close me!</button>-->
                <!--</div>-->
            <!--</div>-->
        <!--</div>-->
        ...
        <div class="modal fade" id="modal-19" role="dialog" aria-labelledby="modalLabeldefault">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-light" data-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-striped table-bordered table-responsive-lg table-responsive-md table-responsive-sm">
                            ...
                            <tr>
                                <td>Long Modals</td>
                                <td>
                                    <a class="btn btn-raised btn-light btn-large" data-toggle="modal"
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body modal_long">
                            {{--<a class="btn btn-light " data-toggle="modal" href="#notlong">Not So Long Modal</a>--}}
