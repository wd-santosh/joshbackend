...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#AddRecordDialogSaveButton, #EditDialogSaveButton').removeClass('btn-light').addClass('btn-primary');
            $('#DeleteDialogButton').removeClass('btn-light').addClass('btn-danger');
            $('#DeleteAllButton,#LoadRecordsButton').removeClass('btn-light');
        });
