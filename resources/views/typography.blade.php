    ...
    <div class="container my-3">
            ...
            <div class="col-md-12 col-lg-4 col-sm-4 col-12">
                ...
                <div class="float-right">
                    <ul class="list-unstyled ">
                        <li class="warning ul_lineheight">The ship set ground on the shore of this uncharted desert isle with Gilligan the Skipper</li>
                        <li class="success ul_lineheight">too the millionaire and his wife. Just two good ol' boys Fightin' the system like a true</li>
                        <li class="primary ul_lineheight">modern day Robin Hood. So join us here each week my friends you're sure to get a smile</li>
                        <li class="danger ul_lineheight">from seven stranded castaways here on Gilligans Isle.It's time to put on makeup.</li>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8  col-sm-12 col-12">
                ...
                <p class="text-nowrap d-none d-lg-inline-block d-sm-inline-block d-md-inline-block">Wouldn't you like to get away? Sometimes you want to go where everybody knows your name.</p>
